...
export const CTA_FOR_CAPABILITY: Readonly<Record<string, { href: string; label: L } | null>> = {
  ...
  "country-readiness": { href: "/work-abroad", label: { en: "Working abroad", lt: "Darbas užsienyje", ru: "Работа за рубежом", nl: "Werken in het buitenland", de: "Arbeiten im Ausland" } },
