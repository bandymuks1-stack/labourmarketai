...
export const INTENT_HINTS: Readonly<Record<RoutedIntent, string>> = {
  ...
  cv: "import or upload a CV file for the person — an explicit write",
  ...
  "journal-skill": "how many recorded hours went to ONE named skill or kind of work, and where it was used ('kiek programavau?', 'where did I use tiling?')",
  ...
  "who-verifies-work": "who can verify or confirm the work the person has already done, and where to submit it",
