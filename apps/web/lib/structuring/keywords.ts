...
export const SKILL_HINTS_LT: SkillHintRow[] = [
  ...
  ...asSector("construction", [
    ...
    {
      slug: "painting",
      needles: ["daž", "dazym", "красил", "покраск", "маляр", "окраш"],
    },
    ...
    {
      slug: "flooring",
      needles: ["grind", "laminat", "parket", "ламинат", "паркет", "напольн"],
    },
    ...
    {
      slug: "insulation",
      needles: ["šiltin", "siltin", "утепл", "теплоизоляц"],
    },
    ...
    {
      slug: "welding-blueprint",
      needles: ["suvirin", "сварк", "сварщик", "сваривал"],
    },
    {
      slug: "scaffolding",
      needles: ["pastol", "подмост", "строительные леса", "строительных лесов"],
    },
    ...
    },
    {
      ...
      needles: ["statyb vadov", "objekt vadov", "прораб"],
    },
    ...
    {
      slug: "general-labour",
      needles: ["darbo paruoš", "darbo pasiruoš", "подсобн", "разнорабоч"],
    },
    ...
    {
      slug: "ventilation",
      needles: ["vėdin", "vedin", "ventiliac", "вентиляц", "вентиляцион"],
    },
    {
      slug: "hvac-install",
      needles: [
    ...
    {
      slug: "heating-install",
      needles: ["šildym", "sildym", "šildymo sistem", "отоплен", "отопительн"],
    },
    {
      slug: "roofing",
      needles: [
    ...
    {
      slug: "sanitary-install",
      needles: [
        "santechnik prietais",
        "santechnik įreng",
        "santechnikos prietais",
        "сантехприбор",
        "санприбор",
      ],
    },
  ...
  ...asSector("office_admin", [
    ...
    // exact needle makes it high confidence (phrase-pack audit 2026-07-04).
    {
      ...
      needles: ["dokument", "document", "документ", "paperwork"],
    },
    {
      slug: "bookkeeping",
      needles: [
  ...
  ...asSector("transport_logistics", [
    ...
    {
      slug: "pallet-handling",
      needles: ["palet", "pallet", "паллет", "поддон"],
    },
    {
      slug: "stock-taking",
      needles: [
  ...
  ...asSector("retail_sales", [
    {
      ...
      needles: [
        ...
        "call centr",
        "call center",
        "atsakinejau i skambu",
        "atsakinėjau į skambu",
        "priemiau skambu",
        "priėmiau skambu",
        "колл-центр",
        "call-центр",
  ...
  ...asSector("repair_maintenance", [
    ...
    },
    {
      ...
      needles: [
        ...
        "taisiau saldytuv",
        "taisiau šaldytuv",
        "skalbimo masin remont",
        "skalbimo mašin remont",
        "appliance repair",
        "repaired appliance",
        "бытовой техник",
        "бытовую техник",
  ...
  ...asSector("hr_recruitment", [
    ...
    // darbo pokalbyje") must never read as recruitment work.
    {
      ...
      needles: [
        ...
        "ieskojau darbuotoj",
        "ieškojau darbuotoj",
        "vedziau darbo pokalb",
        "vedžiau darbo pokalb",
        "kandidatu atrank",
        "kandidatų atrank",
        "recruit",
        ...
        "подбор персонал",
        "подбирал персонал",
        "проводил собеседован",
        "искал сотрудник",
        "рекрут",
      ],
    },
    {
      slug: "personnel-admin",
      needles: [
        "personalo dokument",
        "personalo administrav",
        "personalo apskait",
        "personnel",
        "кадров",
        "оформлял сотрудник",
  ...
  ...asSector("construction", [
    ...
    {
      slug: "mig-mag-welding",
      needles: [
        "mig weld",
        "mig/mag",
        "suvirinimas pusautomat",
        "pusautomatinis suvirin",
        "сварка полуавтомат",
        "варил полуавтомат",
      ],
    },
    ...
    {
      slug: "gas-cutting",
      needles: ["gas cutting", "dujinis pjov", "dujinis pjaust", "газорез"],
    },
    ...
    {
      slug: "tower-crane",
      needles: ["tower crane", "bokstin kran", "bokštin kran", "башенн кран"],
    },
    { slug: "mobile-crane", needles: ["mobile crane", "autokran", "автокран"] },
    {
      slug: "excavator-operator",
      needles: ["excavator", "ekskavator", "экскаватор"],
    },
    {
      slug: "bulldozer-operator",
      needles: ["bulldozer", "buldozer", "бульдозер"],
    },
    {
      slug: "grader-operator",
      needles: ["grader operat", "greider", "грейдер"],
    },
    {
    ...
    {
      slug: "compactor-operator",
      needles: ["plate compactor", "vibroplokst", "vibroplokšt", "виброплит"],
    },
    ...
    {
      slug: "grouting",
      needles: ["grouting", "fugav", "затирка швов", "затирал швы"],
    },
    ...
    // plaster & paint depth
    {
      ...
      needles: [
        "decorative plaster",
        "dekoratyvin tink",
        "декоративн штукатурк",
        "венецианк",
      ],
    },
    {
      slug: "facade-plaster",
      needles: ["facade plaster", "fasado tink", "фасадн штукатурк"],
    },
    {
      slug: "spray-painting",
      needles: [
    ...
    {
      slug: "glazing",
      needles: ["glazing", "stiklinim", "istiklin", "įstiklin", "остеклен"],
    },
    {
      slug: "gutter-install",
      needles: ["gutter", "lietvamzd", "latak", "водосточн", "желоб"],
    },
    {
      slug: "roof-tiling",
      needles: ["roof tile", "cerpi", "čerpi", "черепиц"],
    },
    {
      slug: "flat-roofing",
      needles: [
    ...
    },
    {
      ...
      needles: ["structural steel", "metalo konstrukcij", "металлоконструкц"],
    },
    {
      slug: "precast-install",
      needles: ["precast", "gelzbeton", "gelžbeton", "жби"],
    },
    ...
    {
      slug: "rigging",
      needles: ["rigging", "stropav", "stropuotoj", "стропальщик", "строповк"],
    },
    {
      slug: "setting-out",
      needles: [
...
export const SKILL_HINT_SECTORS: ReadonlyMap<string, SectorKey> = (() => {
  ...
  for (const row of SKILL_HINTS_LT) {
    ...
    if (prev && prev !== row.sector) {
      throw new Error(
        `SKILL_HINTS_LT sector conflict for '${row.slug}': ${prev} vs ${row.sector}`,
      );
    }
...
export const PROFESSION_HINTS_LT: { slug: string; needles: string[] }[] = [
  // Swedish needles (2026-08-14, worker-acquisition readiness loop) target the
  // Arbetsförmedlingen OCCUPATION LABELS — a closed publisher vocabulary —
  // and were derived from the measured production label distribution, never
  // guessed. Needle safety rule learned the hard way: never add a needle that
  // is an everyday word in ANY covered language ("chef" = Swedish for
  // manager, "driver" = Swedish verb "runs"); vacancy categorization now
  // only ever sees occupation label + title, but these rows also serve
  // free-text demand intake, where a stray everyday word would mistag.
  { slug: "tiler", needles: ["plytel", "плитк", "плиточ", "plattsättare"] },
  { slug: "drywaller", needles: ["gipso", "gipskart", "гипсокартон", "гкл"] },
  {
    slug: "painter",
    needles: ["daž", "dazym", "красил", "покраск", "маляр", "målare"],
  },
  {
    slug: "plumber",
  ...
  {
    slug: "welder",
    needles: ["suvirin", "сварк", "сварщик", "сваривал", "svetsare"],
  },
  {
    slug: "rebar_worker",
    needles: ["armatūr", "armatur", "арматур", "armerare"],
  },
  {
    slug: "roofer",
    needles: ["stog", "крыш", "кровл", "кровел", "takläggare", "takmontör"],
  },
  { slug: "foreman", needles: ["brigadin", "vadovav", "бригадир"] },
  { slug: "site_manager", needles: ["statyb vadov", "objekt vadov", "прораб"] },
  {
    slug: "general_laborer",
    needles: [
      "bendr darb",
      "pagalbin",
      "разнорабоч",
  ...
  {
    slug: "crane_operator",
    needles: ["kran", "крановщик", "башенный кран", "башенного крана"],
  },
  {
    slug: "heavy_equipment_operator",
    needles: [
      "ekskavator",
      "buldoz",
      "krautuv",
  ...
  // "chef" was REMOVED as a cook needle 2026-08-14: in Swedish it means
  // MANAGER ("enhetschef", "din närmaste chef"), and it had mistagged
  // hundreds of Swedish nurse/retail/manager ads as cooks (measured in
  // production). Only unambiguous cook forms remain.
  {
    slug: "cook",
    needles: [
      "virej",
  ...
  {
    slug: "translator",
    needles: ["vertej", "vertėj", "переводчик", "translator", "översättare"],
  },
  {
    slug: "teacher",
    needles: [
  ...
  {
    slug: "receptionist",
    needles: ["registrator", "receptionist", "ресепшн", "регистратор"],
  },
  {
    slug: "kitchen_helper",
    needles: [
      "virtuves pagalbinink",
      "virtuvės pagalbinink",
      "kitchen helper",
      "kitchen porter",
      "помощник повара",
      "помощник на кухне",
  ...
  {
    slug: "baker",
    needles: ["kepej", "kepėj", "baker", "пекар", "bagare", "pizzabagare"],
  },
  {
    slug: "call_centre_agent",
    needles: [
      "skambuciu centro operator",
      "skambučių centro operator",
      "call centre agent",
      "call center agent",
      "оператор колл",
      "оператор call",
  ...
  {
    slug: "merchandiser",
    needles: ["merchandiser", "мерчандайзер", "мерчендайзер"],
  },
  {
    slug: "auto_mechanic",
    needles: [
  ...
  {
    slug: "handyman",
    needles: ["handyman", "мастер на час", "smulkaus remonto meistr"],
  },
  {
    slug: "hairdresser",
    needles: ["kirpej", "kirpėj", "hairdresser", "парикмахер", "frisör"],
  },
  { slug: "barber", needles: ["barzdaskut", "barber", "барбер"] },
  {
    slug: "nail_technician",
    needles: [
      "manikiurinink",
      "manikiūrinink",
      "nail technician",
  ...
  },
  {
    ...
    needles: [
      "skalbej",
      "skalbėj",
      "skalbyklos darbuotoj",
      "laundry worker",
      "работник прачечн",
    ],
  },
  // ── Swedish-label coverage rows (2026-08-14) — slugs were already seeded
  //    in public.professions + all 12 locale catalogs but had NO needle row,
  //    so they were unreachable in every language. ─────────────────────────
  {
  ...
  },
  {
    ...
    needles: [
      ...
      "kundtjänst",
      "klientu aptarnavimo specialist",
      "klientų aptarnavimo specialist",
      "customer service",
...
export const WORK_DIRECTION_HINTS_LT: { slug: string; needles: string[] }[] = [
  ...
  // explicit concreting words, not by "structures". Keep the unambiguous ones.
  {
    ...
    needles: ["betonav", "betonuot", "бетонные работ", "монолитн"],
  },
  {
    slug: "electrician",
  ...
  {
    slug: "carpenter",
    needles: ["medienos darb", "stalystės", "столярные работ"],
  },
];
...
export const ACTIVITY_HINTS_LT: {
  ...
  },
  {
    ...
    needles: [
      ...
      "duru montav",
      "langu montav",
      "duris ir langus montav",
      "duru ir langu montav",
      "ставил двери",
      "ставил окна",
      "монтаж дверей",
      "монтаж окон",
  ...
  {
    slug: "tiler",
    label: "Plytelių klojimas",
    needles: ["plytel", "плитк", "плиточ"],
  },
  {
    slug: "drywaller",
