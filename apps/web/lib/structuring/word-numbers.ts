...
const WORD_NUMBERS: Record<string, number> = {
  ...
  du: 2, dvi: 2, dvieju: 2,
  trys: 3, triju: 3,
  keturi: 4, keturios: 4, keturiu: 4,
  penki: 5, penkios: 5, penkiu: 5,
  sesi: 6, sesios: 6, sesiu: 6,
  septyni: 7, septynios: 7, septyniu: 7,
  astuoni: 8, astuonios: 8, astuoniu: 8,
  devyni: 9, devynios: 9, devyniu: 9,
