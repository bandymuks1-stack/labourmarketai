...
export function PreviewChip() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-sm border border-ink-600/70 bg-ink-800/70 px-3 py-1 font-mono text-meta uppercase tracking-label text-text-muted">
      {t("text")}
    </div>
  );
}
