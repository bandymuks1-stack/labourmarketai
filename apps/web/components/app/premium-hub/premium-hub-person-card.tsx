...
import type { PersonVM } from "./premium-hub-data";
import {
  HubEmptyState,
  HubPanel,
  HubProgress,
 ...
 *  0–100 skill score). Honest empty state when the profile is not set up yet. */
export async function PremiumHubPersonCard({ person }: { person: PersonVM }) {
