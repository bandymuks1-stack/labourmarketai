...
| E-w3 — operator telemetry off worker surface | #1253 | `163dde29` | WAGON=E-w3 · STATUS=MERGED · USER_VALUE=LT dokumentų gairių pipeline būsenos (statusSummary + per-item badges) nebe rodomos darbuotojui/įmonei — tik adminui (isSuperadmin, po locale early-return per review P2); needs-legal-review sąžiningumo žymuo liko visiems; ru/nl email placeholder'iai lokalizuoti · REUSED=isSuperadmin · NEW_PRIMITIVES=none · TESTS=16,509 green. |
