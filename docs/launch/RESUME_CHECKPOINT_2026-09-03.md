...
| RED drafts (needs-human-gate) | **#1448** batch A (supply-counts row + agency offer decision + client accept/decline UI + agency-side decision chips; ratchet 259) · **#1454** batch B (education programmes/cohorts/members + demand per profession + programmes UI; ratchet 258) · **#1456** batch C (institution learner outcomes, aggregates only, suppressed < 3; ratchet 258) — all MERGEABLE against `main` (257) · #1441 #1440 #1436 #1433 #1430 #1426 #1421 #1355 #1266 #1046 #1045 #897 #896 #895 #883 #740 |
