...
| Owner's next step | open https://labourmarket.ai/lt/dashboard on the real account (it lands in the agency workspace) and invite ONE real client company by e-mail from the "clients" section; the agent takes over from the first persisted row |
