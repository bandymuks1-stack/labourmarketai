...
| #1441 Stripe | **MERGED `f4b5e582` 2026-09-05 ~16:03 UTC** (owner approval in chat). Vercel Production carries the 8-variable live contract, Preview none. Stripe LIVE objects: product `prod_VCjq8iLCnyfbr2`, price `price_1UCKgg637uptAg5zD8dMA6kU`, portal `bpc_1UCKNU637uptAg5z3ztY0snr`, webhook endpoint (owner) + Tax active. J1–J5/K4 = IMPL_PENDING_PROOF until the acceptance walk + real payment |
