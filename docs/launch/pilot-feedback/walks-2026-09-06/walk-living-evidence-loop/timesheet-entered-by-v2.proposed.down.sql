-- ============================================================================
-- ROLLBACK for the proposed timesheet_entered_by_provenance_v2: restores the
-- 20260831170000 body VERBATIM (extracted from that migration file). Same
-- signature, SECDEF, SET search_path, STABLE and REVOKEs. Apply via MCP only.
-- ============================================================================
