...
| ORG-11 | Universal invitation / referral network | `invitations` (extended: open link, campaign seats, demand target, external source + consent), `invitation_acceptances` (ledger), `/api/referrals/external/v1` | **BLOCKED** | — | 0 | `20260917120000` APPLIED 2026-09-17 (ledger `20260917080303`), RPCs production-proven, secret set; **OWNER?** apply forward fix `20260917130000` (one identifier) + merge #1752 code, then walk CASE 1–19 |
