...
| ORG-5 | Cross-org isolation | 7 authority helpers | PARTIAL | — | 0 | manager reads/creates/updates projects and reads the roster via `manages_organization` (owner RED approval 2026-09-24, ledger `20260924092836`); roster **management** (worker invitations, invite/provision/role RPCs) and project DELETE stay owner/admin; open: the manager's real-session walk |
