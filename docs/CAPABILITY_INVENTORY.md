...
| ORG-11 | Universal invitation / referral network | `invitations` (extended: open link, campaign seats, demand target, external source + consent), `invitation_acceptances` (ledger), `/api/referrals/external/v1` | **BLOCKED** | — | 0 | `20260917120000` (ledger `20260917080303`) + forward fix `20260917130000` (ledger `20260917091045`) APPLIED 2026-09-17, RPCs production-proven, secret set; merge #1752 → walk CASE 1–19 on production |
