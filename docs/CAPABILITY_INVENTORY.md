...
| ORG-11 | Universal invitation / referral network | `invitations` (extended: open link, campaign seats, demand target, external source + consent), `invitation_acceptances` (ledger), `/api/referrals/external/v1` | **BLOCKED** | — | 0 | **OWNER?** apply `20260917120000` (RED, unapplied) + set `EXTERNAL_REFERRAL_TOKEN_NONSTOP`; app falls back to v1 RPCs until then |
