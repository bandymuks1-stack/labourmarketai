...
| W7 | Employee journey | ~60%; zero P0; P1-1/#981, P1-2/#979 closed; **P1-4 inventory DONE** | #979 #981 | none own | local journey ✔ (83 shots) + **profile measured at 1440/375** (`docs/audits/W7_PROFILE_FULL_INVENTORY.md`) | P1-3 conversation memory (SQL still in `docs/proposals/`, never a migration); **P1-4 audit complete — 21 sections inventoried, 6104 px / 8823 px, 5 duplicate readiness summaries ≈1350 px, 34 unlabelled inputs, 73 sub-44 px targets, ≈15 serial await stages; 5 slices W7-S1…S5 proposed, none implemented**; P2-1 open-ended bookings skip the overlap guard | **PARTIAL** | **yes** | execute W7-S1 (collapse the 5 duplicate readiness summaries into `ProfileHubOverview`) then W7-S3 (flatten the waterfall) |
