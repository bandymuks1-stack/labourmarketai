...
| W6 | Trust / experience domain | **Schema ACTIVE in prod** (applied 2026-08-04, ledger 173→174); `experiences` result = `real`; local full cycle proven. **Author/subject slice CODE COMPLETE 2026-08-06**: org-scoped bookings resolve organization subjects, `author_side` model added, moderation queue names subject+author side; DB proof 35/35 + v1 regression 43/43 + rollback cycle + browser 9/9 (`docs/human-gates/experience-author-subject-v1-gate.md`) | #972–#974 #977 #1008 + author/subject Draft PR | `20260802120000` APPLIED; `20260806230000` **UNAPPLIED (owner gate W6-D1)** | local ✔ / prod write **pending** | owner gate W6-D1 (apply `20260806230000`); production write proof (PROD_QA gate) | **PARTIAL → code complete, two owner gates** | no (gates recorded) | owner: decide W6-D1 + PROD_QA |
