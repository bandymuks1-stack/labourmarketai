...
> Audit date **2026-08-02** · base commit `c05a4802` · source `audit/w10-marketplace-matching` @ `6f858b10`.
> Findings are frozen exactly as written and were **not** re-scored against later work.
> Closed since this audit: **P0-1** by PR #986 (`c4d564c1`), **P0-2** by PR #989 (`9bb01e3b`), **P0-3** by PR #992 (`2813c78b`).
