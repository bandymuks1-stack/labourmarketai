# J3 — accessibility basics walk on production AFTER the fixes (#1435 deployed, 2026-09-02)
...
| anon | `/lt/jobs` | `/lt/jobs` | lt | 1 | 2 | no | main landmark count = 2 |
...
| anon | `/lt/for-workers` | `/lt/for-workers` | lt | 1 | 1 | no | none |
| anon | `/lt/for-companies` | `/lt/for-companies` | lt | 1 | 1 | no | none |
...
| walker | `/lt/dashboard` | `/lt/dashboard` | lt | 1 | 1 | no | none |
...
| walker | `/lt/dashboard/planning` | `/lt/dashboard/planning` | lt | 1 | 1 | no | none |
...
Routes walked: 21. Routes with zero issues: 19.