-- Rollback for 20260922130000_company_need_intake_country_registry_v1.sql
-- Restores the 10-code market list condition; everything else identical. Only for hard
-- technical failure — it re-creates the market gate the owner rule 2026-09-22 forbids.
