-- Rollback for 20260903130000_opportunity_type_internship_apprenticeship_v1
-- Safe: re-declares the projection with the previous five-value allowlist.
-- Demands that carry 'internship' / 'apprenticeship' keep their rows; only the
-- worker-safe projection stops emitting that one key. No data is touched.
