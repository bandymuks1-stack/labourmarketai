-- Rollback for 20260922140000_privacy_consent_rpc_locale_pl_v1.sql
-- Restores the five-locale allowlist ('lt','en','ru','nl','de') in the three consent grant
-- functions, everything else identical. NOTE: after this rollback a /pl-UI worker is again
-- answered unsupported_locale; only for hard technical failure. Consent rows already recorded
-- with locale 'pl' are evidence and are NOT touched.
