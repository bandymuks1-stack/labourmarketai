-- Rollback for 20260830100000_esco_canonical_linkage_67.sql
-- Mechanical by exact slug+uri list: nulls ONLY rows still holding exactly
-- the value the migration wrote, so a later deliberate re-curation is never
-- destroyed by this rollback.

update public.skills s
   set esco_uri = null, updated_at = now()
  from (values
