...
-- decision 4a.) This file's objects are LIVE in production. It was applied as
-- THREE ledger rows, not one:
--     journal_entry_photos_table    (version 20260612072652)  part 1/3
--     journal_entry_photos_rpc      (version 20260612072736)  part 2/3
--     journal_entry_photos_storage  (version 20260612075300)  part 3/3
-- Canonical accounting: REVIEWED_APPLY_SHAPES in
-- apps/web/lib/migrations/parity-model.ts (kind: "split").
...
-- present; the table holds 11 rows of REAL worker photo evidence.
-- Re-running it would re-execute DDL against objects carrying live data.
-- The file stays in the tree for history and for clean-rebuild parity.
-- ============================================================================
