...
--
-- Production ledger version : 20260728114254
-- Production ledger name    : usage_cost_events_v1_reapply
-- Applied to production     : 2026-07-28 11:42:54 UTC, via Supabase MCP apply_migration
...
--                             production's stored statements. md5 = 76066638444ff54e96a56028263f63b8.
--                             Verify: strip the banner up to and including the
--                             marker line, then md5sum the remainder.
-- ROLLBACK                  : supabase/rollbacks/20260728114254_usage_cost_events_v1_reapply.down.sql —
...
drop policy if exists usage_cost_events_select on public.usage_cost_events;
